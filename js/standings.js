const Standings = (() => {
  ...
  function render(matchData, selectedGroup) {
    ...
    keys.forEach(g => {
      ...
      html += `<th class="text-center hidden sm:table-cell">${I18n.t('winner')}</th>`;
      html += `<th class="text-center hidden sm:table-cell">${I18n.t('draw')}</th>`;
      html += `<th class="text-center hidden sm:table-cell">${I18n.t('loser')}</th>`;
      html += `<th class="text-center hidden sm:table-cell">${I18n.t('gf')}</th>`;
      html += `<th class="text-center hidden sm:table-cell">${I18n.t('ga')}</th>`;
      ...
      standings.forEach((row, idx) => {
        ...
        html += `<td class="text-center text-green-400 hidden sm:table-cell">${row.won || ''}</td>`;
        html += `<td class="text-center text-gray-400 hidden sm:table-cell">${row.drawn || ''}</td>`;
        html += `<td class="text-center text-red-400 hidden sm:table-cell">${row.lost || ''}</td>`;
        html += `<td class="text-center hidden sm:table-cell">${row.goalsFor}</td>`;
        html += `<td class="text-center hidden sm:table-cell">${row.goalsAgainst}</td>`;
