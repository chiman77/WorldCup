const I18n = (() => {
  ...
  const teamNames = {
    ...
    'Ghana': { zh: '加纳', 'zh-tw': '迦納', en: 'Ghana', flag: '🇬🇭', espn: 'gha', info: { apps: 5, best: { zh: '1/4决赛（2010）', en: 'Quarter-finals (2010)' }, intro: { zh: '西非足球强国，2010年闯入八强追平非洲最佳战绩。以身体对抗和技术结合的风格著称，青训体系在非洲名列前茅。', en: 'West African football power, reached QF in 2010 matching Africa\'s best. Known for combining physicality with technique.' } } },
