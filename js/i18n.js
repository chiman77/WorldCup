const I18n = (() => {
  ...
  const teamNames = {
    ...
    'Cote d\'Ivoire': { zh: '科特迪瓦', 'zh-tw': '象牙海岸', en: "Côte d'Ivoire", flag: '🇨🇮', espn: 'civ', info: { apps: 5, best: { zh: '小组赛', en: 'Group stage' }, intro: { zh: '西非足球强国，21世纪初以德罗巴、亚亚·图雷等黄金一代球员崛起。曾夺非洲杯冠军，多次入围世界杯正赛。', en: 'West African football power that rose with the golden generation of Drogba and Yaya Touré. Regular World Cup participants.' } } },
    ...
    'Ecuador': { zh: '厄瓜多尔', 'zh-tw': '厄瓜多', en: 'Ecuador', flag: '🇪🇨', espn: 'ecu', info: { apps: 5, best: { zh: '16强（2006）', en: 'Round of 16 (2006)' }, intro: { zh: '南美洲高原劲旅，利用高原主场优势闻名。2006年首次打入淘汰赛，近年来持续保持竞争力，青训产出稳定。', en: 'South American high-altitude powerhouse. Reached Round of 16 in 2006, consistently competitive in CONMEBOL.' } } },
    ...
    'Cabo Verde': { zh: '佛得角', 'zh-tw': '維德角', en: 'Cabo Verde', flag: '🇨🇻', espn: 'cpv', info: { apps: 1, best: { zh: '首次参赛', en: 'Debut' }, intro: { zh: '大西洋岛国，首次参加世界杯正赛。近年来足球水平快速提升，创造了该国体育史上的里程碑时刻。', en: 'Atlantic island nation making World Cup debut. Football rapidly improving, achieving a historic milestone for the country.' } } },
    'Saudi Arabia': { zh: '沙特阿拉伯', 'zh-tw': '沙烏地阿拉伯', en: 'Saudi Arabia', flag: '🇸🇦', espn: 'ksa', info: { apps: 7, best: { zh: '16强（1994）', en: 'Round of 16 (1994)' }, intro: { zh: '亚洲传统强队，1994年首次参赛即闯入十六强。以技术风格和足球投资闻名，曾在世界杯上击败世界冠军阿根廷。', en: 'Traditional Asian powerhouse, reached Round of 16 in debut 1994 tournament. Known for technical style and football investment.' } } },
